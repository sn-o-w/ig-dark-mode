...
(function() {var css = [
	...
	"}",
	"._ab6o._ab6q+._aj3f, ._ab6o:not(._ab6q)+._aac6 {",
	"    border-radius: 4px !important;",
	...
	"    border-bottom: 1px solid rgb(var(--ig-separator)) !important;",
	"}",
	"._akej ._ackh > * > ._aao_, ._akej ._ackg > * > ._aao_ {",
	"    margin-left: -11.5px !important;",
	"    width: 104.93% !important;",
	"}",
	"._aa25 {",
	"    border-radius: 4px !important;",
	"    border-top: 1px solid rgb(var(--ig-separator)) !important;",
	...
	"    padding-right: 11.5px !important;",
	"}",
	"._aauo, ._ab6o:not(._ab6q)+._aac6>._aac8 {",
	"    margin-left: -11.5px !important;",
	"}",
	"._aauo ._aap1 {",
	"    padding-left: 11.5px !important;",
	...
	"}",
	"/* \"Switch accounts\" */",
	".x7r02ix .xougopr::after {",
	"    border-right: 1px solid #565656 !important;",
	"}",
	".x7r02ix .xnp5s1o::after {",
	"    border-left: 1px solid #565656 !important;",
	"}",
	".x7r02ix .x1ykvv32::after {",
	"    border-top: 1px solid #565656 !important;",
	"}",
	".x7r02ix .x159fomc::after {",
	...
	"/* Add \"._aa4d\._aa4c .x10cihs4>*>*:not(.x5qyhuo)\" to not modify within Stories page */",
	"/* Add a specific rule for dark theme where canvas border look awful within Stories page and needs manual fix */",
	"._aa4d .x10cihs4>*>*:not(.x5qyhuo) ._aarf>canvas:not([style*=\"width: 42px; height: 42px;\"], [style*=\"width: 54px; height: 54px;\"], [style*=\"width: 66px; height: 66px;\"], [style*=\"width: 91px; height: 91px;\"], [style*=\"width: 168px; height: 168px;\"]), ._aa4d ._aams>canvas {",
	"    filter: brightness(1.59) !important;",
	"}",
	"._aa4c .x10cihs4>*>*:not(.x5qyhuo) ._aarf>canvas:not([style*=\"width: 42px; height: 42px;\"], [style*=\"width: 54px; height: 54px;\"], [style*=\"width: 66px; height: 66px;\"], [style*=\"width: 91px; height: 91px;\"], [style*=\"width: 168px; height: 168px;\"]), ._aa4c ._aams>canvas {",
	"    filter: brightness(0.395) !important;",
	"}",
	"._aa4d .x10cihs4>*>.x5qyhuo ._aarf>canvas[style*=\"width: 64px; height: 64px;\"] {",
	...
	"}",
	"._aa90 > svg > circle:not([class]) {",
	"    fill: rgb(var(--ig-secondary-background)) !important;",
	"}",
	".x184cenk ._aa90 > svg > circle:not([class]) {",
	...
	"/* ._aav5 used within https://instagram.com/accounts/edit/ */",
	"._abm4:hover:not(:focus), ._abn_, .-qQT3:hover:not(:focus), ._aeas:hover:not(:focus), *:not(.xivu535)>*>*>*>.x1l895ks:hover:not(:focus), ._ab85>*:not(._aav5)>.x78zum5:hover:not(._ab87):not(:focus) {",
	"    background: #2e2e2e !important;",
	"}",
	"._aeas:focus, .-qQT3:focus, ._ab85>*:not(._aav5)>.x78zum5._ab88:focus:not(._ab87) {",
	...
	"}",
	"[data-bloks-name][style*=\"color: rgb(115, 115, 115)\"] {",
	"    color: rgb(168, 168, 168) !important;",
	"}",
	"[data-bloks-name][style*=\"background: rgb(219, 219, 219)\"][style*=\"width: 100%\"], [data-bloks-name][style*=\"background: rgb(54, 54, 54)\"][style*=\"height: 0.5px\"], [data-bloks-name][style*=\"background: rgb(38, 38, 38)\"][style*=\"width: 100%\"], [data-bloks-name][style*=\"background: rgb(219, 219, 219)\"][style*=\"height: 1px\"], [data-bloks-name][style*=\"background: rgb(38, 38, 38)\"][style*=\"height: 1px\"] {",
	...
	"    border-bottom: 1px solid rgb(var(--ig-elevated-separator)) !important;",
	"}",
	"[data-bloks-name][style*=\"background-color: rgb(38, 38, 38)\"], [data-bloks-name=\"ig.components.Icon\"][style*=\"background-color: rgb(0, 0, 0)\"] {",
	"    background-color: rgb(255, 255, 255) !important;",
	"}",
	".wbloks_1[data-bloks-name=\"bk.components.Flexbox\"][style*=\"border: 0.5px solid rgb(199, 199, 199)\"] {",
	"    border: 0.5px solid rgb(130, 130, 130) !important;",
	"}",
	"[data-bloks-name=\"bk.components.BoxDecoration\"][style=\"background: rgba(0, 0, 0, 0.9);\"] {",
