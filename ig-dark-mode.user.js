...
(function() {var css = [
	...
	"._acum ._aagx>*, .s4Iyt, .sp_6waKHQ8D7KJ.sx_6383e0 {",
	"    filter: invert(1) !important;",
	"}",
	...
	"._9-z-, .glyphsSpriteCamera__outline__24__grey_9, ._9zlg, ._9zli, ._9zlh, .coreSpriteKeyhole, ._9zkj, ._9_1o, ._9-_z, ._9--3, ._9-_-, .coreSpriteLockSmall {",
	"    filter: invert(1) !important;",
	"}",
