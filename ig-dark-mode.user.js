...
(function() {var css = [
	...
	"/* Stuff for Help section, for instance here: https://instagram.com/settings/help/ + other Settings pages + small fix for \"About this account\" */",
	"span[data-bloks-name=\"bk.components.Text\"][style*=\"line-height: 1.625\"]:not([style*=\"color:\"]), span[data-bloks-name=\"bk.components.Text\"][style*=\"line-height: 1.3\"]:not([style*=\"color:\"]) {",
	"    color: rgb(250, 250, 250) !important;",
	"}",
