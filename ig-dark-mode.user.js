...
(function() {var css = [
	...
	"}",
	".xw7yly9 > .x1e56ztr ._acay, .xw7yly9 .xcbkimw {",
	"    padding-left: 3.5px !important;",
	"}",
	"article .x13zqm9e {",
	"    border-bottom: 1px solid transparent !important;",
	"}",
	".xw7yly9 article > .x11aubdm, .xw7yly9 > div:nth-child(2) > div > div:not([class]) > div[style] > div[class] > div:nth-child(1), .xw7yly9 .x1hq5gj4 {",
	...
	"}",
	"article > .x11aubdm > .xsag5q8, article > .x11aubdm > .x1lliihq, .xw7yly9 .x1hq5gj4 .x1e558r4 {",
	"    padding-left: 11.5px !important;",
	"    padding-right: 11.5px !important;",
	"}",
	"footer.xvbhtw8, ._agh4 {",
	"    background: rgb(var(--ig-secondary-background)) !important;",
	"}",
	/* Still have no idea how much of the older code is reusable. Needs more testing */
	/*
