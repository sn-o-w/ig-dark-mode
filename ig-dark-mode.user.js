...
(function() {var css = [
	...
	"/* .xvbhtw8 is used in the new Instagram UI) */",
	"/* i[style*=\"https://static.cdninstagram.com/rsrc.php/v3/yi/r/ZFtnMBJnHU_.png\"] is used on login page */",
	"._acum ._aagx>*, .xvbhtw8 ._aagx>*, .s4Iyt, .sp_6waKHQ8D7KJ.sx_6383e0, i[style*=\"https://static.cdninstagram.com/rsrc.php/v3/yi/r/ZFtnMBJnHU_.png\"] {",
	"    filter: invert(1) !important;",
	"}",
	...
	"}",
	//"/* Fix textarea for \"Add a comment\" */",
	//"._aao9 > textarea {",
	...
	"}",
	"/* General selector */",
	"._abm4:hover, ._abn_, .-qQT3:hover {",
	"    background: #2e2e2e !important;",
	"}",
	"._abm4:focus, .-qQT3:focus {",
	...
	"._9-z-, .glyphsSpriteCamera__outline__24__grey_9, ._9zlg, ._9zli, ._9zlh, .coreSpriteKeyhole, ._9zkj, ._9_1o, ._9-_z, ._9--3, ._9-_-, ._9--q, .coreSpriteLockSmall, .glyphsSpriteSearch__outline__24__grey_9 {",
	"    filter: invert(1) !important;",
	"}",
