...
(function() {var css = [
	...
	"}",
	"/* \"Suggestions for you\" */",
	"/* IG still temporarily experiments with _aalf */",
	"._aalf::before {",
	...
	"}",
	"[data-bloks-name=\"bk.components.Flexbox\"][style*=\"background: rgb(255, 255, 255)\"][style*=\"padding: 8px 12px\"] > * > [data-bloks-name=\"bk.components.TextSpan\"][style*=\"color: rgb(0, 0, 0)\"], [data-bloks-name=\"bk.components.TextSpan\"][style*=\"color: rgb(0, 53, 105)\"], [data-bloks-name=\"bk.components.TextSpan\"][style*=\"color: rgb(0, 55, 107)\"], [data-bloks-name=\"bk.components.Text\"][style*=\"color: rgb(223, 239, 255)\"], [data-bloks-name=\"bk.components.Text\"][style*=\"color: rgb(0, 53, 105)\"] {",
